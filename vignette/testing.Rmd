...
### This will print updates of coverage per iteration to your consol. It should run in a minute or so.
 ...
 out <-  sim.causalGLM(cross_fit = F, formula = ~1 + W1 + W2 + W3 + W4, n=n, p = p, learning_method = "glmnet",    nsims = 100, estimand= "CATE", compare_with_competitor = T )
...
```{r}
sim.RR(formula_estimand =~1 + W1 + W2, n=n, p=p )$data[,-c(1,2,3)]
...
#p=4 is number of covariates in W
### This will print updates of coverage per iteration to your consol. It should run in a minute or so.
  out <-  sim.causalGLM(cross_fit = F, formula = ~1 + W1 +W2 + W3 + W4   , n=n, p = p, learning_method = "xgboost", nsims = nsims, estimand= "OR", compare_with_competitor = T)
...
#p=4 is number of covariates in W
### This will print updates of coverage per iteration to your consol. It should run in a minute or so.
 out <-  sim.causalGLM(cross_fit = F, formula = ~1 + W1 + W2 + W3 + W4, n=n, p = p, learning_method = "glmnet", nsims = nsims, estimand= "OR", compare_with_competitor = T, include_glmnet_in_stack = F)
...
#p=4 is number of covariates in W
### This will print updates of coverage per iteration to your consol. It should run in a minute or so.
 out <-  sim.causalGLM(cross_fit = F, formula = ~1 , n=n, p = p, learning_method = "glmnet", nsims = nsims, estimand= "CATE", compare_with_competitor = T )
...
#p=4 is number of covariates in W
### This will print updates of coverage per iteration to your consol. It should run in a minute or so.
 out <-  sim.causalGLM(cross_fit = F, formula = ~1    , n=n, p = p, learning_method = "glmnet", nsims = nsims, estimand= "RR", compare_with_competitor = T , print_CI_length = F)
...
#p=4 is number of covariates in W
### This will print updates of coverage per iteration to your consol. It should run in a minute or so.
 out <-  sim.causalGLM(cross_fit = T, formula = ~1 , n=n, p = p, learning_method = "xgboost", nsims = nsims, estimand= "OR", compare_with_competitor = T, full_fit_as_offset = F )
